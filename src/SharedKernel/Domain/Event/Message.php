...
{
    private const MESSAGE_COMPANY_NAME = 'company';
    ...
    abstract protected function boundedContext();
    abstract protected function messageType();
    abstract protected function messageName();

    public function name(): string
    {
        //common_platform.marketing.advantage.benefit.domain_event.benefit_created
        //barberify.booking.appointment.domain_event.user_was_created
        return sprintf(
            '%s.%s.%s.%s',
